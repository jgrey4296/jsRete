...
/**
   A Data structure to hold what you need to start a retenet.
   @class ReteNet
*/
var ReteNet = function(){
    ...
    */
    ...
    /** @alias {module:ReteComparisonOperators} */
    this.ComparisonOperators = ComparisonOperators;
    /** @alias {module:ReteArithmeticActions} */
    this.ArithmeticOperators = ArithmeticOperators;
    /** @alias {module:ReteDataStructures.ProposedAction} */
    this.ProposedAction = RDS.ProposedAction;
    /** @alias {module:ReteDataStructures.WME} */
    this.WME = RDS.WME;
    /** @alias {module:ReteDataStructures.Token} */
    this.Token = RDS.Token;

    /**
       All rules loaded into the ReteNet
       @member {Object} allRules
    ...
    /**
       ...
       @member {Object} allReteNodes       
     */
    this.allReteNodes = {};
    /**
       All ReteNodes, indexed by type
       @member {Object} allReteNodesByType
     */
